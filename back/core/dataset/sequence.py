...
class Dataset(Sequence):
    ...
    def __init__(self, cfg, verbose=0):
        ...
        self.name_path = init.TRAIN.NAME_PATH #cfg['yolo']['name_path']
        self.anno_path = init.TRAIN.TRAIN_ANNO_PATH #cfg["train"]["anno_path"]
        self.image_size = cfg["train"]["image_size"]
        self.batch_size = init.TRAIN.BATCH_SIZE #cfg["train"]["batch_size"]
